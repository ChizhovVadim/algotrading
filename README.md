...
- торговать советника через Quik. Можно реализовать интерфейс IBroker для поддержки API разных брокеров.
...
- нет смысла делать прогноз всего из трех возможностей (кеш, лонг, шорт), как обычно для простоты делает человек. Аналогично тому как в машинном обучении классифицируют изображения: столько то процентов собака, столько то кошка и тп. Так и мы будем строить прогноз в виде вещественного числа в отрезке [-1,+1].
